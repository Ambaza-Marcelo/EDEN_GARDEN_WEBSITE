     ...
     <div class="login-area">
        <div class="container">
            <div class="login-box ptb--100">
                <img src="{{ asset('frontend/assets/img/undraw_beer_xg5f.svg') }}" width="250">
                <form method="POST" action="{{ route('admin.login.submit') }}">
                    @csrf
                    <div class="login-form-head">
                      <!--  <h4>Sign In</h4> -->
                        <p>
                             <img src="{{ asset('frontend/assets/img/eden_logo.png')}}" alt="logo EDEN" width="100" height="20">
                        </p>
                    </div>
                    <div class="login-form-body">
                        ...
                        <div class="row mb-4 rmber-area">
                            ...
                            <div class="col-6 text-right">
                                <a href="#">@lang('messages.forgotpwd')?</a>
                            </div>
                        </div>
                ...
                <img src="{{ asset('frontend/assets/img/undraw_chef_cu-0-r.svg') }}" width="250">
            </div>
        </div>
    </div>
    <!-- login area end -->
