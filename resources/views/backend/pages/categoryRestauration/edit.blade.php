        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.category_restaurations.update', $categoryRestauration->id) }}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input name="name" type="text" class="form-control" value="{{ $categoryRestauration->name }}">
                                    </div>
                                </div>
                            </div>
                            </div>
