                        ...
                        <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="name">Nom Microfinance<span class="text-danger"></span></label>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input autofocus type="url" class="form-control" name="facebook" placeholder="Entrer le lien facebook" required minlength="6" maxlength="255">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="gasape">Gasape<span class="text-danger"></span></label>
                                        <input autofocus type="url" class="form-control" name="gasape" placeholder="Entrer le lien Gasape " required minlength="6" maxlength="255">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        <label for="linkedln">Linkedln<span class="text-danger"></span></label>
                                        <input autofocus type="url" class="form-control" name="linkedln" placeholder="Entrer le lien Linkedln" required minlength="5" maxlength="255">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
