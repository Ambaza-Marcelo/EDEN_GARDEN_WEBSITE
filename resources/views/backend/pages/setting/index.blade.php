...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">Paramètres</h4>
                    @if (Auth::guard('admin')->user()->can('setting.edit'))
                    <p class="float-right mb-2">
                            <a class="btn btn-primary text-white" href="{{ route('admin.settings.create') }}">@lang('Nouveau')</a>
                    </p>
                    @endif
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        @if (Auth::guard('admin')->user()->can('setting.edit'))
                                            <a class="btn btn-success text-white" href="{{ route('admin.settings.edit', $setting->id) }}">Modifier</a>
                                        @endif
