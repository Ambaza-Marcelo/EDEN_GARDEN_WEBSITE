...
@section('title')
Messages - @lang('messages.admin_panel')
@endsection
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">Messages</h4>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        ...
                                        @if (Auth::guard('admin')->user()->can('message.delete'))
                                            <a class="btn btn-danger text-white" href="{{ route('admin.messages.destroy', $message->id) }}"
