        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.restaurations.store') }}" method="POST"  enctype="multipart/form-data">
                        @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select class="form-control" name="category_restauration_id" id="category_restauration_id">
                                            ...
                                            <option value="{{ $categoryRestauration->id }}" class="form-control">{{ $categoryRestauration->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input autofocus type="number" class="form-control" name="old_price" placeholder="Entrer l'ancien prix ">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        <label for="price">Prix<span class="text-danger"></span></label>
                                        <input type="number" class="form-control" placeholder="Entrer Le Prix" name="price" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
