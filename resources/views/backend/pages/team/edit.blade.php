        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.teams.index') }}">@lang('messages.list')</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input autofocus type="text" class="form-control" name="name" value="{{ $team->name }}" required minlength="2" maxlength="255">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select class="form-control" name="position_id" id="position_id">
                                            ...
                                            <option value="{{ $position->id }}" {{$team->position_id == $position->id  ? 'selected' : ''}} ">{{ $position->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
